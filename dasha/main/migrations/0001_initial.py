    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=254, verbose_name='Имя')),
                ('status', models.CharField(choices=[('new', 'Новая'), ('confirmed', 'Принято в работу'), ('canceled', 'Выполнено')], default='new', max_length=254, verbose_name='Статус')),
                ('photo_file', models.ImageField(blank=True, max_length=254, null=True, upload_to='', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['png', 'jpg', 'jpeg', 'bmp'])])),
                ('descriptions', models.TextField(blank=True, verbose_name='описание')),
                ('imageses', models.ImageField(blank=True, default='', upload_to='', verbose_name=' Доп Изображение')),
